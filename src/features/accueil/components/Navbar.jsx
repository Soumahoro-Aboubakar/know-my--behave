      ...
      <div className="relative flex justify-between px-4 mx-3 items-center lg:text-sm flex-shrink-0">
        <div className="flex space-x-3 items-center text-xl">
          <img
            ...
            className="h-12 w-12"
          />
          <span className="font-semibold hidden md:block text-4xl">
            Rimcov.
          </span>
        </div>
          ...
          {navItems.map((item, index) => (
            <li key={index}>
              <Link
                ...
                to={item.href}
                offset={-60}
                className="hover:text-blue-500 transition duration-300 cursor-pointer text-stone-400"
              >
                {item.label}
              </Link>
            </li>
        ...
        <div className="hidden lg:flex space-x-12 items-center">
          <Link
            className="py-2 px-3 rounded-md bg-gradient-to-r from-blue-500 to-blue-800 cursor-pointer"
            smooth={true}
            duration={1000}
            offset={-60}
